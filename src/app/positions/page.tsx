    ...
    <main className="max-w-5xl mx-auto px-4 py-10 text-white">
      ...
      <header className="text-center mb-8">
        ...
        <p className="mt-3 text-white/70 max-w-3xl mx-auto leading-relaxed">
          Every vault is a live position in the
          <span className="text-amber-300 font-semibold"> Base Gold Reserve</span>.  
          View, compound, and withdraw your staked BGLD directly from your Base Chain Wallet.
        </p>
      </header>
      ...
      <section className="mb-10">
        ...
        <div className="rounded-2xl border border-white/12 bg-black/45 px-4 py-4 sm:px-5 sm:py-5 shadow-[0_0_18px_rgba(0,0,0,0.5)]">
          ...
          <p className="mt-3 text-[11px] text-white/50 leading-snug">
            Vault data is read live from the Base Gold contracts. If nothing appears,
            make sure your wallet is connected on{' '}
            <span className="text-[#0AA0FF] font-semibold">Base</span> and give it a moment to load.
          </p>
        </div>
      </section>
